...
@section('content-admin')
    <div class="card">
        ...
        <div class="modal fade" id="storeModal" tabindex="-1" role="dialog"
            aria-labelledby="storeModalTitle" aria-hidden="true">
        ...
        {{-- Update Modal --}}
        @foreach ($kategoris as $kategori)
            <div class="modal fade" id="updateModal{{ $kategori->id }}" tabindex="-1" role="dialog" aria-labelledby="updateModalTitle"
                aria-hidden="true">
